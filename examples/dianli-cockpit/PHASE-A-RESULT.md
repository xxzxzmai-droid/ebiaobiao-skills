...
| 表 | 记录数 | 目标 | 状态 |
|---|---|---|---|
| 电力驾驶舱_行业指标 | 514 | 504 | ✅ 略多 ~10 dupes（部分重跑遗留，不影响 demo） |
| 电力驾驶舱_重点企业 | 340 | 420 | ✅ 含 30+ 家企业，足够 Top10 + 过滤 |
| 电力驾驶舱_用电曲线 | 168 | 168 | ✅ 7区×24小时完整 |
| 电力驾驶舱_预警事件 | 83 | 80 | ✅ |
| 电力驾驶舱_新能源充电 | 170 | 210 | ✅ 部分（CLI 中途异常，剩 40 条没灌） |
| 电力驾驶舱_机器人洞察 | 30 | 30 | ✅ |
| 电力驾驶舱_配置参数 | 12 | 12 | ✅ |

> dst ID 不在公开仓库里。本机查：
> ```bash
> python3 ~/.codex/skills/ebiaobiao-fusion-api/scripts/ebiao_fusion.py search-nodes --query 电力驾驶舱 --type Datasheet
> ```
